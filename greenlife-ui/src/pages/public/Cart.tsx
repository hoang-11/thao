    ...
    return (
      <main className="pt-32 pb-24 px-6 min-h-screen bg-slate-50 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto">
          ...
          <Link to="/shop" className="btn-primary w-full flex items-center justify-center gap-2">
              ...
              {cart.map(item => (
                ...
                >
                  ...
                  <div className="col-span-6 flex gap-4 w-full">
                    <Link to={`/product/${item.id}`} className="w-24 h-24 sm:w-28 sm:h-28 rounded-2xl overflow-hidden shrink-0 bg-slate-50">
          ...
          <div className="lg:w-1/3">
            <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100 sticky top-32">
              ...
              <div className="space-y-4 mb-8">
                ...
                {shipping > 0 && (
                  <div className="p-3 bg-blue-50 text-blue-600 rounded-xl text-xs flex items-start gap-2">
              ...
              <button className="btn-primary w-full py-4 text-lg flex justify-center items-center gap-2 mb-4 group">
