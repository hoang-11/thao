    ...
    setTimeout(() => {
      ...
      setResult({
        ...
        treatmentSteps: [
          ...
          'Dùng kéo đã khử trùng cắt bỏ cẩn thận những lá có vết đốm nhiễm bệnh nặng. Bỏ vào túi nilon kín vứt đi.',
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              {/* Shine effect */}
              {!isAnalyzing && !(!image) && (
                <div className="absolute top-0 -left-[100%] w-1/2 h-full bg-gradient-to-r from-transparent via-white/20 to-transparent skew-x-[-20deg] group-hover:animate-[shine_1.5s_ease-in-out_infinite]" />
              )}
            </button>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="space-y-4 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-200 before:to-transparent hidden">
                      {/* CSS Line hidden above, implemented custom timeline below */}
                    </div>
                  ...
                  <div className="p-6 bg-slate-900 rounded-3xl text-white mt-8 relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                      ...
                      <Link to="/services" className="inline-flex py-3 px-6 bg-accent text-primary rounded-xl font-bold hover:bg-white transition-all items-center gap-2 shadow-lg">
