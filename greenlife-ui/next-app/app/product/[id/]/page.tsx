    ...
    return (
      <main className="pt-32 pb-24 px-6 min-h-screen flex items-center justify-center bg-slate-50">
        <div className="text-center">
          ...
          <Link href="/shop" className="btn-primary">Quay lại cửa hàng</Link>
        </div>
      </main>
    );
  }
  ...
  return (
    <main className="pt-24 pb-24 min-h-screen bg-slate-50">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="bg-white rounded-[40px] shadow-sm border border-slate-100 overflow-hidden flex flex-col lg:flex-row mb-16 animate-fade-in">
