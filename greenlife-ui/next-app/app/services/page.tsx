...
export default function Services() {
  ...
  const handleNextStep = () => {
    if (step === 1 && validateStep1()) {
      ...
      // Call mock Node.js route if needed, or simply set step 3
      fetch('/api/bookings', {
        method: 'POST',
      ...
      .catch(() => {
        // Fallback to step 3 on error for demo purposes
        setStep(3);
      });
    }
  };
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          {experts.map(expert => (
                            ...
                            >
                              <img src={expert.avatar} alt={expert.name} className="w-12 h-12 rounded-full object-cover animate-fade-in" />
