      ...
      <div className="max-w-7xl mx-auto">
        ...
        {blogPosts.length > 0 && (
          <motion.div 
            ...
            className="mb-16 bg-white rounded-[40px] overflow-hidden shadow-sm border border-slate-100 flex flex-col lg:flex-row group cursor-pointer animate-fade-in"
          >
            ...
            <div className="lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center">
              ...
              <Link href={`/blog/${blogPosts[0].id}`} className="mt-auto inline-flex items-center gap-2 font-bold text-primary group-hover:gap-3 transition-all">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogPosts.slice(1).map((post, index) => (
            <motion.div
              ...
              className="bg-white rounded-3xl overflow-hidden shadow-sm border border-slate-100 group cursor-pointer flex flex-col hover:shadow-md transition-shadow"
            >
              ...
              <div className="p-6 flex-1 flex flex-col">
                ...
                <div className="flex items-center justify-between mt-auto pt-4 border-t border-slate-100">
                  ...
                  <Link href={`/blog/${post.id}`} className="text-primary hover:text-emerald-700 transition-colors">
                    <BookOpen size={18} />
                  </Link>
                </div>
              </div>
